...
import com.madultech.booking.security.JwtAuthFilter;
...
//
//                        // Resources: read is open to any authenticated user, writes are ADMIN only
...
//                        // both roles may hit these endpoints, but USER only ever sees/affects their own data.
